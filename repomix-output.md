...
efms-frontend/
  ...
  src/
    components/
      ...
      Dashboard.js
      DashboardHeader.js
      DeptHeadExitQueue.js
      DeptHeadLeaveQueue.js
      DocumentsSection.js
      EmployeeList.js
      EmployeeModal.js
      ExitSection.js
...
## File: efms-backend/middleware/auth.js
```javascript
...
## File: efms-backend/middleware/rateLimit.js
```javascript
...
## File: efms-backend/routes/applications.js
```javascript
...
## File: efms-backend/routes/auditLog.js
```javascript
const express = require('express');
const db = require('../db');
...
## File: efms-backend/routes/auth.js
```javascript
const express = require('express');
...
## File: efms-backend/routes/departments.js
```javascript
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
...
## File: efms-backend/routes/documents.js
```javascript
const express = require('express');
const multer = require('multer');
const path = require('path');
...
## File: efms-backend/routes/employees.js
```javascript
const express = require('express');
const crypto = require('crypto');
const multer = require('multer');
...
## File: efms-backend/routes/exitRecords.js
```javascript
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
...
## File: efms-backend/routes/leaveRequests.js
```javascript
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
...
## File: efms-backend/routes/messages.js
```javascript
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
...
## File: efms-backend/routes/payments.js
```javascript
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
...
## File: efms-backend/routes/positions.js
```javascript
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
...
## File: efms-backend/routes/vacancies.js
```javascript
const express = require('express');
const db = require('../db');
const { authenticateToken, requireAdmin } = require('../middleware/auth');
...
## File: efms-backend/scripts/createAdmin.js
```javascript
...
## File: efms-backend/utils/auditLog.js
```javascript
const db = require('../db');
...
## File: efms-backend/utils/mailer.js
```javascript
...
## File: efms-backend/utils/validate.js
```javascript
...
## File: efms-backend/nodemon.json
```json
{
  "watch": ["server.js", "db.js", "middleware", "routes", "utils", "scripts"],
  "ext": "js,json",
  "ignore": [
    "node_modules/*",
    "uploads/*",
...
## File: efms-backend/package.json
```json
{
  "name": "efls-backend",
  "version": "1.0.0",
...
## File: efms-frontend/public/index.html
```html
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <!--
      Sets the light/dark theme attribute on <html> before React (or even
      the CSS) paints anything. This must stay a plain blocking inline
      script — if it's deferred, moved after CSS, or rewritten to run
      after mount, the flash-of-wrong-theme bug comes right back. Keep
      this key in sync with THEME_KEY in src/hooks/useTheme.js.
    -->
    <script>
      (function () {
        try {
          var stored = localStorage.getItem('efms_theme');
          var theme =
          ...
          // the CSS media-query default, no attribute needed.
        }
      })();
    </script>
  </head>
...
## File: efms-frontend/public/manifest.json
```json
{
...
## File: efms-frontend/public/robots.txt
```
...
## File: efms-frontend/src/components/ApplicantReview.js
```javascript
...
## File: efms-frontend/src/components/ApplyPage.js
```javascript
...
## File: efms-frontend/src/components/AuditLogView.js
```javascript
...
## File: efms-frontend/src/components/ContactHRPage.js
```javascript
...
## File: efms-frontend/src/components/Dashboard.js
```javascript
...
## File: efms-frontend/src/components/DashboardHeader.js
```javascript
...
## File: efms-frontend/src/components/DeptHeadExitQueue.js
```javascript
import { useState, useEffect } from 'react';
...
## File: efms-frontend/src/components/DeptHeadLeaveQueue.js
```javascript
import { useState, useEffect } from 'react';
...
## File: efms-frontend/src/components/DocumentsSection.js
```javascript
import { useState } from 'react';
...
## File: efms-frontend/src/components/EmployeeList.js
```javascript
...
## File: efms-frontend/src/components/EmployeeModal.js
```javascript
...
## File: efms-frontend/src/components/ExitSection.js
```javascript
import { useState } from 'react';
...
## File: efms-frontend/src/components/HomePage.js
```javascript
...
## File: efms-frontend/src/components/HRExitQueue.js
```javascript
import { useState, useEffect } from 'react';
...
## File: efms-frontend/src/components/HRLeaveQueue.js
```javascript
import { useState, useEffect } from 'react';
import { BASE_URL } from '../api';
...
## File: efms-frontend/src/components/icons.js
```javascript
...
## File: efms-frontend/src/components/LeaveSection.js
```javascript
import { useState, useEffect } from 'react';
...
## File: efms-frontend/src/components/Login.js
```javascript
...
## File: efms-frontend/src/components/LoginRoute.js
```javascript
...
## File: efms-frontend/src/components/MessageCenter.js
```javascript
import { useState, useEffect, useRef, useCallback } from 'react';
...
## File: efms-frontend/src/components/MyRecordView.js
```javascript
import { useState, useEffect } from 'react';
import DocumentsSection from './DocumentsSection';
import LeaveSection from './LeaveSection';
...
## File: efms-frontend/src/components/PaymentsSection.js
```javascript
import { useState } from 'react';
...
## File: efms-frontend/src/components/PrivacyPolicyPage.js
```javascript
...
## File: efms-frontend/src/components/SelfRegisterPage.js
```javascript
...
## File: efms-frontend/src/components/SiteFooter.js
```javascript
...
## File: efms-frontend/src/components/SiteHeader.js
```javascript
...
## File: efms-frontend/src/components/StatusCheckPage.js
```javascript
...
## File: efms-frontend/src/components/TermsOfServicePage.js
```javascript
...
## File: efms-frontend/src/components/VacancyManager.js
```javascript
import { useState, useEffect } from 'react';
...
## File: efms-frontend/src/hooks/useTheme.js
```javascript
...
## File: efms-frontend/src/utils/format.js
```javascript
...
## File: efms-frontend/src/App.css
```css
:root {
  --color-bg: #faf8f6;
  --color-surface: #ffffff;
  --color-surface-alt: #f3efec;
  --color-border: #e6e0da;
  --color-text: #1c1a18;
  --color-text-secondary: #625d57;
  --color-text-muted: #99928a;
  --color-accent: #cf5b2c;
  --color-accent-hover: #b44b21;
  --color-danger: #4b5563;
  --color-danger-hover: #374151;
  --color-success: #0f6e91;
...
@media (prefers-color-scheme: dark) {
  :root:not([data-theme="light"]) {
    ...
    --color-border: #37342f;
    --color-text: #f5f1ec;
    --color-text-secondary: #b8b2ab;
    --color-text-muted: #837d76;
    --color-accent: #e8763d;
    --color-accent-hover: #f28a51;
    --color-danger: #9aa4b2;
    --color-danger-hover: #b7c0cc;
    --color-success: #45b8e0;
...
.modal-employee-identity {
  display: flex;
  align-items: center;
  gap: 12px;
}

.modal-employee-identity h2 {
  margin: 0 0 4px;
}
...
.chat-bubble.mine .chat-bubble-tag {
  color: #ffe6b3;
}
...
@media (max-width: 600px) {
  ...
  .conversation-list-panel.hide-on-mobile {
    display: none;
  }
...
.btn-primary {
  background: var(--color-accent);
  color: #fff;
  box-shadow: 0 1px 2px rgba(0, 0, 0, 0.08), 0 6px 16px -6px var(--color-accent);
}
...
/* ============================================================
   Legal & Static Pages (Terms, Privacy, Contact HR)
   ============================================================ */
...
/* ============================================================
   Auth & Public Forms (Login, Apply, Status, Self-Register)
   ============================================================ */
...
.status-applicant { color: var(--color-text-secondary); }
.status-under-review { color: var(--color-warning); border-color: var(--color-warning); }
.status-interview { color: var(--color-accent); border-color: var(--color-accent); }
.status-hired { color: var(--color-success); border-color: var(--color-success); }
.status-rejected { color: var(--color-danger); border-color: var(--color-danger); }
...
/* ============================================================
   Theme: Secondary Blue Accent (info / secondary badges)
   ============================================================ */
...
/* Reserve orange for primary CTAs only — secondary in-context actions
   (Manage, Grant Access, Cancel, etc.) now read as blue everywhere. */
.link-btn {
...
/* Wide, unboxed shell for internal pages — replaces the narrow public
   `.container` so the dashboard actually uses the viewport instead of
   sitting in a small centered card with dead space on either side.
   Individual sections get their own `.dash-panel` cards instead. */
.dash-content {
  max-width: 1280px;
  margin: 0 auto;
...
/* Stat strip — real, already-fetched numbers (total / departments /
   positions), giving the page a sense of scale before the table. */
.dash-stats-row {
  display: grid;
...
.dash-form-card {
  ...
  border-radius: var(--radius);
  background: var(--color-surface);
  animation: form-panel-in 0.18s ease-out;
}
...
.dash-form-grid .field-group input,
.dash-form-grid .field-group select {
  padding: 10px 12px;
  font-size: 14px;
}
...
/* Table wrapped in its own card, separate from stat cards and the
   add-employee form, so the page reads as distinct, breathing panels
   rather than one dense box. */
.dash-table-panel {
  background: var(--color-surface);
  border: 1px solid var(--color-border);
  border-radius: var(--radius);
...
/* Status pill colors not already covered by the auth-pages block */
.status-active { color: var(--color-success); border-color: var(--color-success); }
.status-exited { color: var(--color-text-muted); }
...
## File: efms-frontend/src/App.test.js
```javascript
...
## File: efms-frontend/src/index.css
```css
body {
  margin: 0;
...
## File: efms-frontend/src/index.js
```javascript
...
## File: efms-frontend/src/logo.svg
```xml
...
## File: efms-frontend/src/reportWebVitals.js
```javascript
...
## File: efms-frontend/src/setupTests.js
```javascript
...
## File: efms-frontend/package.json
```json
{
  "name": "efms-frontend",
  "version": "0.1.0",
...
<file path="efms-backend/middleware/auth.js">
const jwt = require('jsonwebtoken');
const db = require('../db');
...
<file path="efms-backend/middleware/rateLimit.js">
const rateLimit = require('express-rate-limit');
...
<file path="efms-backend/routes/applications.js">
const express = require('express');
const multer = require('multer');
const path = require('path');
const crypto = require('crypto');
...
<file path="efms-backend/routes/auditLog.js">
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
...
<file path="efms-backend/routes/auth.js">
const express = require('express');
const bcrypt = require('bcrypt');
const jwt = require('jsonwebtoken');
const db = require('../db');
...
<file path="efms-backend/routes/departments.js">
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
...
<file path="efms-backend/routes/documents.js">
const express = require('express');
const multer = require('multer');
const path = require('path');
const db = require('../db');
...
<file path="efms-backend/routes/employees.js">
const express = require('express');
const crypto = require('crypto');
const multer = require('multer');
const path = require('path');
...
<file path="efms-backend/routes/exitRecords.js">
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
const { logAction } = require('../utils/auditLog');
...
<file path="efms-backend/routes/leaveRequests.js">
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
const { logAction } = require('../utils/auditLog');
...
<file path="efms-backend/routes/messages.js">
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
const { logAction } = require('../utils/auditLog');
...
<file path="efms-backend/routes/payments.js">
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
const { logAction } = require('../utils/auditLog');
...
<file path="efms-backend/routes/positions.js">
const express = require('express');
const db = require('../db');
const { authenticateToken } = require('../middleware/auth');
...
<file path="efms-backend/routes/vacancies.js">
const express = require('express');
const db = require('../db');
const { authenticateToken, requireAdmin } = require('../middleware/auth');
const { logAction } = require('../utils/auditLog');
...
<file path="efms-backend/scripts/createAdmin.js">
require('dotenv').config();
const bcrypt = require('bcrypt');
const db = require('../db');
...
<file path="efms-backend/utils/auditLog.js">
const db = require('../db');
...
<file path="efms-backend/utils/mailer.js">
const nodemailer = require('nodemailer');
...
<file path="efms-backend/utils/validate.js">
const EMAIL_RE = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
...
<file path="efms-backend/.gitignore">
node_modules/
.env
uploads/
</file>

<file path="efms-backend/db.js">
require('dotenv').config();
const mysql = require('mysql2');
...
<file path="efms-backend/nodemon.json">
{
  "watch": ["server.js", "db.js", "middleware", "routes", "utils", "scripts"],
  "ext": "js,json",
  "ignore": [
...
<file path="efms-backend/package.json">
{
  "name": "efls-backend",
  "version": "1.0.0",
  "description": "",
...
<file path="efms-backend/server.js">
const express = require('express');
const cors = require('cors');
const db = require('./db');
const authRoutes = require('./routes/auth');
...
<file path="efms-frontend/public/index.html">
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
...
<file path="efms-frontend/public/manifest.json">
{
  "short_name": "React App",
  "name": "Create React App Sample",
  "icons": [
...
<file path="efms-frontend/public/robots.txt">
# https://www.robotstxt.org/robotstxt.html
User-agent: *
Disallow:
</file>

<file path="efms-frontend/src/components/ApplicantReview.js">
import { useState } from 'react';
import { fetchDocuments, updateEmployeeStatus, BASE_URL } from '../api';
...
<file path="efms-frontend/src/components/ApplyPage.js">
// src/components/ApplyPage.js
import { useState, useEffect, useCallback } from 'react';
import { Link } from 'react-router-dom';
import { fetchPublicVacancies, submitApplication } from '../api';
...
<file path="efms-frontend/src/components/AuditLogView.js">
import { useState, useEffect } from 'react';
import { fetchAuditLog } from '../api';
...
<file path="efms-frontend/src/components/ContactHRPage.js">
// src/components/ContactHRPage.js
import { Link } from 'react-router-dom';
import SiteHeader from './SiteHeader';
import SiteFooter from './SiteFooter';
...
<file path="efms-frontend/src/components/Dashboard.js">
// src/components/Dashboard.js
import { useState, useEffect } from 'react';
import { useSearchParams } from 'react-router-dom';
import Login from './Login';
...
<file path="efms-frontend/src/components/DashboardHeader.js">
// src/components/DashboardHeader.js
import { useTheme } from '../hooks/useTheme';
import { LogoMark, SunIcon, MoonIcon } from './icons';
import { initials, roleLabel } from '../utils/format';
...
<file path="efms-frontend/src/components/DeptHeadExitQueue.js">
import { useState, useEffect } from 'react';
import { fetchDeptExitQueue, acknowledgeExit } from '../api';
...
<file path="efms-frontend/src/components/DeptHeadLeaveQueue.js">
import { useState, useEffect } from 'react';
import { BASE_URL } from '../api';
...
<file path="efms-frontend/src/components/DocumentsSection.js">
import { useState } from 'react';
import { uploadDocument, deleteDocument } from '../api';
...
<file path="efms-frontend/src/components/EmployeeList.js">
// src/components/EmployeeList.js
import { useState, useEffect, useRef, useCallback } from 'react';
import {
  createEmployee,
...
<file path="efms-frontend/src/components/EmployeeModal.js">
// src/components/EmployeeModal.js
import DocumentsSection from './DocumentsSection';
import LeaveSection from './LeaveSection';
import PaymentsSection from './PaymentsSection';
...
<file path="efms-frontend/src/components/ExitSection.js">
import { useState } from 'react';
import { submitExit } from '../api';
...
<file path="efms-frontend/src/components/HomePage.js">
// src/components/HomePage.js
import { Link } from 'react-router-dom';
import SiteHeader from './SiteHeader';
import SiteFooter from './SiteFooter';
...
<file path="efms-frontend/src/components/HRExitQueue.js">
import { useState, useEffect } from 'react';
import { fetchHRExitQueue, finalizeExit } from '../api';
...
<file path="efms-frontend/src/components/HRLeaveQueue.js">
import { useState, useEffect } from 'react';
import { BASE_URL } from '../api';
...
<file path="efms-frontend/src/components/icons.js">
// Shared icon set + small decorative line-art for the internal
// dashboard. The empty-state and header art reuse the same CSS token
// classes (doc-outline / doc-line / wall-shape / wall-line) as the
// public homepage's hero illustrations, so the visual language matches.
...
<file path="efms-frontend/src/components/LeaveSection.js">
import { useState, useEffect } from 'react';
import { createLeaveRequest, deleteLeaveRequest } from '../api';
...
<file path="efms-frontend/src/components/Login.js">
// src/components/Login.js
import { useState } from 'react';
import { login } from '../api';
import SiteHeader from './SiteHeader';
...
<file path="efms-frontend/src/components/LoginRoute.js">
import { useEffect, useState } from 'react';
import { useNavigate } from 'react-router-dom';
import Login from './Login';
...
<file path="efms-frontend/src/components/MessageCenter.js">
import { useState, useEffect, useRef, useCallback } from 'react';
import { fetchContacts, fetchConversations, fetchThread, markThreadRead, sendMessage } from '../api';
...
<file path="efms-frontend/src/components/MyRecordView.js">
import { useState, useEffect } from 'react';
import DocumentsSection from './DocumentsSection';
import LeaveSection from './LeaveSection';
import PaymentsSection from './PaymentsSection';
...
<file path="efms-frontend/src/components/PaymentsSection.js">
import { useState } from 'react';
import { createPayment, deletePayment } from '../api';
...
<file path="efms-frontend/src/components/PrivacyPolicyPage.js">
// src/components/PrivacyPolicyPage.js
import { Link } from 'react-router-dom';
import SiteHeader from './SiteHeader';
import SiteFooter from './SiteFooter';
...
<file path="efms-frontend/src/components/SelfRegisterPage.js">
// src/components/SelfRegisterPage.js
import { useState } from 'react';
import { useSearchParams, Link } from 'react-router-dom';
import { selfRegister } from '../api';
...
<file path="efms-frontend/src/components/SiteFooter.js">
// src/components/SiteFooter.js
import { Link } from 'react-router-dom';
...
<file path="efms-frontend/src/components/SiteHeader.js">
// src/components/SiteHeader.js
import { Link, useLocation } from 'react-router-dom';
import { useTheme } from '../hooks/useTheme';
...
<file path="efms-frontend/src/components/StatusCheckPage.js">
// src/components/StatusCheckPage.js
import { useState } from 'react';
import { Link } from 'react-router-dom';
import { checkApplicationStatus } from '../api';
...
<file path="efms-frontend/src/components/TermsOfServicePage.js">
// src/components/TermsOfServicePage.js
import { Link } from 'react-router-dom';
import SiteHeader from './SiteHeader';
import SiteFooter from './SiteFooter';
...
<file path="efms-frontend/src/components/VacancyManager.js">
import { useState, useEffect } from 'react';
import { fetchVacancies, createVacancy, updateVacancy, approveVacancy, rejectVacancy, deleteVacancy, fetchDepartments } from '../api';
...
<file path="efms-frontend/src/hooks/useTheme.js">
// Shared light/dark theme toggle. The very first paint's correct
// data-theme value is set by a blocking script in public/index.html
// (before React even mounts) so there's no flash of the wrong theme.
// This hook just reads whatever is already on <html> at mount time and
...
<file path="efms-frontend/src/utils/format.js">
// Shared formatting helpers used across the dashboard. Pulled out of
// Dashboard.js / EmployeeList.js / DashboardHeader.js, which each used
// to redeclare their own copies of these.
...
<file path="efms-frontend/src/api.js">
const BASE_URL = 'http://localhost:5000';
...
<file path="efms-frontend/src/App.css">
:root {
  --color-bg: #faf8f6;
  --color-surface: #ffffff;
  --color-surface-alt: #f3efec;
...
<file path="efms-frontend/src/App.js">
// src/App.js
import { BrowserRouter, Routes, Route } from 'react-router-dom';
import './App.css';
import HomePage from './components/HomePage';
...
<file path="efms-frontend/src/App.test.js">
import { render, screen } from '@testing-library/react';
import App from './App';
...
<file path="efms-frontend/src/index.css">
body {
  margin: 0;
  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Oxygen',
    'Ubuntu', 'Cantarell', 'Fira Sans', 'Droid Sans', 'Helvetica Neue',
...
<file path="efms-frontend/src/index.js">
import React from 'react';
import ReactDOM from 'react-dom/client';
import './index.css';
import App from './App';
...
<file path="efms-frontend/src/logo.svg">
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 841.9 595.3"><g fill="#61DAFB"><path d="M666.3 296.5c0-32.5-40.7-63.3-103.1-82.4 14.4-63.6 8-114.2-20.2-130.4-6.5-3.8-14.1-5.6-22.4-5.6v22.3c4.6 0 8.3.9 11.4 2.6 13.6 7.8 19.5 37.5 14.9 75.7-1.1 9.4-2.9 19.3-5.1 29.4-19.6-4.8-41-8.5-63.5-10.9-13.5-18.5-27.5-35.3-41.6-50 32.6-30.3 63.2-46.9 84-46.9V78c-27.5 0-63.5 19.6-99.9 53.6-36.4-33.8-72.4-53.2-99.9-53.2v22.3c20.7 0 51.4 16.5 84 46.6-14 14.7-28 31.4-41.3 49.9-22.6 2.4-44 6.1-63.6 11-2.3-10-4-19.7-5.2-29-4.7-38.2 1.1-67.9 14.6-75.8 3-1.8 6.9-2.6 11.5-2.6V78.5c-8.4 0-16 1.8-22.6 5.6-28.1 16.2-34.4 66.7-19.9 130.1-62.2 19.2-102.7 49.9-102.7 82.3 0 32.5 40.7 63.3 103.1 82.4-14.4 63.6-8 114.2 20.2 130.4 6.5 3.8 14.1 5.6 22.5 5.6 27.5 0 63.5-19.6 99.9-53.6 36.4 33.8 72.4 53.2 99.9 53.2 8.4 0 16-1.8 22.6-5.6 28.1-16.2 34.4-66.7 19.9-130.1 62-19.1 102.5-49.9 102.5-82.3zm-130.2-66.7c-3.7 12.9-8.3 26.2-13.5 39.5-4.1-8-8.4-16-13.1-24-4.6-8-9.5-15.8-14.4-23.4 14.2 2.1 27.9 4.7 41 7.9zm-45.8 106.5c-7.8 13.5-15.8 26.3-24.1 38.2-14.9 1.3-30 2-45.2 2-15.1 0-30.2-.7-45-1.9-8.3-11.9-16.4-24.6-24.2-38-7.6-13.1-14.5-26.4-20.8-39.8 6.2-13.4 13.2-26.8 20.7-39.9 7.8-13.5 15.8-26.3 24.1-38.2 14.9-1.3 30-2 45.2-2 15.1 0 30.2.7 45 1.9 8.3 11.9 16.4 24.6 24.2 38 7.6 13.1 14.5 26.4 20.8 39.8-6.3 13.4-13.2 26.8-20.7 39.9zm32.3-13c5.4 13.4 10 26.8 13.8 39.8-13.1 3.2-26.9 5.9-41.2 8 4.9-7.7 9.8-15.6 14.4-23.7 4.6-8 8.9-16.1 13-24.1zM421.2 430c-9.3-9.6-18.6-20.3-27.8-32 9 .4 18.2.7 27.5.7 9.4 0 18.7-.2 27.8-.7-9 11.7-18.3 22.4-27.5 32zm-74.4-58.9c-14.2-2.1-27.9-4.7-41-7.9 3.7-12.9 8.3-26.2 13.5-39.5 4.1 8 8.4 16 13.1 24 4.7 8 9.5 15.8 14.4 23.4zM420.7 163c9.3 9.6 18.6 20.3 27.8 32-9-.4-18.2-.7-27.5-.7-9.4 0-18.7.2-27.8.7 9-11.7 18.3-22.4 27.5-32zm-74 58.9c-4.9 7.7-9.8 15.6-14.4 23.7-4.6 8-8.9 16-13 24-5.4-13.4-10-26.8-13.8-39.8 13.1-3.1 26.9-5.8 41.2-7.9zm-90.5 125.2c-35.4-15.1-58.3-34.9-58.3-50.6 0-15.7 22.9-35.6 58.3-50.6 8.6-3.7 18-7 27.7-10.1 5.7 19.6 13.2 40 22.5 60.9-9.2 20.8-16.6 41.1-22.2 60.6-9.9-3.1-19.3-6.5-28-10.2zM310 490c-13.6-7.8-19.5-37.5-14.9-75.7 1.1-9.4 2.9-19.3 5.1-29.4 19.6 4.8 41 8.5 63.5 10.9 13.5 18.5 27.5 35.3 41.6 50-32.6 30.3-63.2 46.9-84 46.9-4.5-.1-8.3-1-11.3-2.7zm237.2-76.2c4.7 38.2-1.1 67.9-14.6 75.8-3 1.8-6.9 2.6-11.5 2.6-20.7 0-51.4-16.5-84-46.6 14-14.7 28-31.4 41.3-49.9 22.6-2.4 44-6.1 63.6-11 2.3 10.1 4.1 19.8 5.2 29.1zm38.5-66.7c-8.6 3.7-18 7-27.7 10.1-5.7-19.6-13.2-40-22.5-60.9 9.2-20.8 16.6-41.1 22.2-60.6 9.9 3.1 19.3 6.5 28.1 10.2 35.4 15.1 58.3 34.9 58.3 50.6-.1 15.7-23 35.6-58.4 50.6zM320.8 78.4z"/><circle cx="420.9" cy="296.5" r="45.7"/><path d="M520.5 78.1z"/></g></svg>
</file>

<file path="efms-frontend/src/reportWebVitals.js">
const reportWebVitals = onPerfEntry => {
  if (onPerfEntry && onPerfEntry instanceof Function) {
    import('web-vitals').then(({ getCLS, getFID, getFCP, getLCP, getTTFB }) => {
      getCLS(onPerfEntry);
...
<file path="efms-frontend/src/setupTests.js">
// jest-dom adds custom jest matchers for asserting on DOM nodes.
// allows you to do things like:
// expect(element).toHaveTextContent(/react/i)
// learn more: https://github.com/testing-library/jest-dom
...
<file path="efms-frontend/.gitignore">
# See https://help.github.com/articles/ignoring-files/ for more about ignoring files.
...
<file path="efms-frontend/package.json">
{
  "name": "efms-frontend",
  "version": "0.1.0",
  "private": true,
...
<file path="efms-frontend/README.md">
# Getting Started with Create React App
